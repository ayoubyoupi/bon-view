...
TOKEN = '7393375325:AAF0D27TjAOfISD_UXn3_XlkjGjxeSCN7WQ'
bot = telebot.TeleBot(TOKEN)

ALLOWED_USERS = [5066539368, 7306675136, 6162561053, 6783750964, 7321197230, 5894939334, 7148402097]
...
def send_phone(message):
    if not is_user_allowed(message.from_user.id):
        bot.reply_to(message, "انت غير مشترك في هذا البوت يرجى تحدث مع المطور من اجل الاشتراك @DZ_22 🤍.")
        return

    bot.reply_to(message, "بوت SK YOOZ جاهز لخدمتكم الان يمكنكم التسجيل للحصول على جيغات في كل 20 دقيقة بدون عناء فقط ارسل رقم والرمز مرة واحدة ♥🇵🇸 ")
